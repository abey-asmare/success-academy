...
export const sampleCourse: Course = {
  ...
  description:
    "Master modern web development with React, Node.js, and database technologies. This comprehensive course will take you from beginner to professional developer.",
  duration: "12 weeks",
